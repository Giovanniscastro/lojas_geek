...
namespace lojas_geek.Migrations
{
    public partial class novas : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DadosPag", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Endereco = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DadosPagId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Venda_DadosPag_DadosPagId",
                        column: x => x.DadosPagId,
                        principalTable: "DadosPag",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProdutoVenda_Produto_ProdutosId",
