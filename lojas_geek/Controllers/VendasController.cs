...
namespace lojas_geek.Controllers
{
    public class VendasController : Controller
    {
        ...
        public VendasController(lojas_geekContext context)
        {
            _context = context;
        }
        ...
        {
            var lojas_geekContext = _context.Venda.Include(v => v.Cliente).Include(v => v.DadosPagamento);
        ...
        public IActionResult Create()
        {
            ...
            ViewData["DadosPagId"] = new SelectList(_context.Set<DadosPag>(), "Id", "Id");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Datavenda,Endereco,DadosPagId,ClienteId")] Venda venda)
        {
            ...
            ViewData["DadosPagId"] = new SelectList(_context.Set<DadosPag>(), "Id", "Id", venda.DadosPagId);
            return View(venda);
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'lojas_geekContext.Venda'  is null.");
            }
            var venda = await _context.Venda.FindAsync(id);
            if (venda != null)
            {
